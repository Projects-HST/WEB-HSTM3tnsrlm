...
//#################### Attendance task update ####################//
    ...
    function add_attendance_task($mobilizer_id,$task_type,$task_id,$attendance_date,$title,$comments,$status,$user_id,$created_at){
      ...
      $query="INSERT INTO mobilizer_attendance(mobilizer_id,pia_id,work_type_id,task_id,title,comments,attendance_date,status,created_at,created_by) VALUES('$mobilizer_id','$user_id','$task_type','$task_id','$title','$comments','$atten_date','Active','$user_id',NOW())";
      $result = $this->db->query($query);
