                  ...
                  <div class="form-example-wrap">
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                ...
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" readonly placeholder="Enter Email" value="<?php echo $row->user_name; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Name</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="pia_name" placeholder="Enter Email" value="<?php echo $row->name; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Email</label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="pia_email" placeholder="Enter Email" value="<?php echo $row->email; ?>">
                        ...
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Phone </label>
                                <div class="nk-int-st">
                                    <input type="text" class="form-control input-sm" name="pia_phone" placeholder="Enter Email" value="<?php echo $row->phone; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="form-example-int">
                            <div class="form-group">
                                <label>Address</label>
                                <div class="nk-int-st">
                                    <textarea class="form-control" rows="5" name="pia_address" placeholder=""><?php echo $row->address; ?></textarea>
                                </div>
                            </div>
                        </div>
