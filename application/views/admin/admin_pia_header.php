              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                      <li id="dashboard"><a  href="<?php echo base_url(); ?>admin/home"><i class="fa fa-th-large" aria-hidden="true"></i> Dashboard</a></li>
					   ...
					   <li id="masters"><a  href="<?php echo base_url(); ?>scheme/home"><i class="fa fa-book fa-fw" aria-hidden="true"></i> Scheme</a></li>
                  ...
                  <div class="tab-content custom-menu-content">
                      <div id="piamenu" class="tab-pane notika-tab-menu-bg animated flipInX">
                          <ul class="notika-main-menu-dropdown">
							  ...
							  <li><a href="<?php echo base_url(); ?>admin/pia_dashboard/<?php echo $piaid; ?>" id="pia_dash">Partner Dashboard</a></li>
