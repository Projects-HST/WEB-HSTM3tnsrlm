				 ...
				 <div class="form-example-int form-horizental">
					  ...
					  <div class="row page_row">
							...
							<div class="row page_row">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                                        <label class="hrzn-fm">E-Mail ID of Candidate <span class="error">*</span></label>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
										<input type="text" placeholder="E-Mail ID of Candidate" name="email"  class="form-control input-sm" maxlength="30">
                                    </div>
                           </div>
