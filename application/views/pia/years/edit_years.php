                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <div class="form-example-wrap mg-t-30">
                          <div class="cmp-tb-hd cmp-int-hd">
                              <h2>Update Years Configuration Form</h2>
                          </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                                   ...
                                   <div class="input-group date nk-int-st">
                                       ...
                                       <input type="text"  name="from_month" id="from_year" class="form-control datepicker" value="<?php echo $rows->period_from; ?>" >
                              ...
                              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="form-group nk-datapk-ctm form-elet-mg" id="data_1">
                                   ...
                                   <div class="input-group date nk-int-st">
                                       <span class="input-group-addon"></span>
                                       <input type="text" name="end_month" id="to_year"  class="form-control datepicker"  value="<?php echo $rows->period_to; ?>" >
                                   </div>
                               </div>
                              </div>
