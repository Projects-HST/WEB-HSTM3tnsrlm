		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="form-example-wrap">
				<div class="form-example-int">
							...
							<tr>
								 <td colspan="2" style="font-weight:bold;">PIA Name</td><td colspan="7"><?php echo $detailed_report['pia_name']; ?></td><!--<td style="text-align:right;"><a class="pull-right btn btn-primary btn-xs" href="<?php echo base_url(); ?>staff/detailed_generateXls/<?php echo base64_encode($mobi_id*98765);?>/<?php echo $detailed_report['year'];?>/<?php echo $sMonth; ?>"><i class="fa fa-file-excel-o"></i> Export Data</a></td>-->
							</tr>
							<tr>
